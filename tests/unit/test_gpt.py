...
class TestGetAssistant:
    ...
    def test_get_assistant_success(self, mock_openai_client, mocker):
        ...
        with patch('gpt.settings') as mock_settings:
            ...
            mock_openai_client.beta.assistants.retrieve.assert_called_once_with(
                "asst_test123"
            )
...
class TestGenerateChatGPTImage:
    ...
    def test_generate_image_response_not_ok(self, mock_openai_client, mocker, mock_image_processing):
